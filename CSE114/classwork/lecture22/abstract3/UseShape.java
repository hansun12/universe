...
public class UseShape {
    ...
    public static void heterogeneousArray () {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println(ha[i]);  // same thing once more
        }
        ...
        for (Object sh : ha) {
            ((Shape)sh).translate(1.0, 1.0);  // How about this way?
        }
    }
    ...
    public static void trouble () {
        ...
        System.out.println(((Circle)s1).circumference());  // this works!
        ...
        //
        // Also see Subtype.java for a summary of all this.
    }
}
